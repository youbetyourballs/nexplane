#!/usr/bin/env python3
"""
Nexplane Multi-Cloud Live Smoke Test — Phases A–O.
...
def main():
    ...
    parser.add_argument(
        ...
        help="Comma-separated phases to run (A-O). Phase J is slow (~35 min, RDS). GCP phases L-M require --gcp-project. Azure phases N-O require --azure-resource-group.",
    )
