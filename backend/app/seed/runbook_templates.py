...
SEED_TEMPLATES = [
    ...
    },
    {
        ...
        "description": "Revoke access and rotate credentials for a departing employee",
        "tags": ["offboarding", "identity"],
        "steps": [
            {"step_number": 1, "name": "Disable IAM User", "type": "change",
             "change_type": "disable_iam_user", "on_failure": "abort",
             "parameters": {"username": ""}},
            {"step_number": 2, "name": "Disable Okta User", "type": "change",
             "change_type": "okta_disable_user", "on_failure": "abort",
             "parameters": {"user_id": ""}},
            {"step_number": 3, "name": "Disable Azure AD User", "type": "change",
             "change_type": "azure_ad_disable_user", "on_failure": "abort",
             "parameters": {"user_id": ""}},
            {"step_number": 4, "name": "Disable LDAP Account", "type": "change",
             "change_type": "ldap_disable_user", "on_failure": "abort",
             "parameters": {"username": ""}},
            {"step_number": 5, "name": "Lock Teleport User", "type": "change",
             "change_type": "teleport_lock_user", "on_failure": "abort",
             "parameters": {"username": ""}},
            {"step_number": 6, "name": "Suspend GitLab Account", "type": "change",
             "change_type": "gitlab_suspend_user", "on_failure": "abort",
             "parameters": {"username": ""}},
            {"step_number": 7, "name": "Rotate SSH Keys", "type": "change",
             "change_type": "rotate_ssh_keys", "on_failure": "abort",
             "parameters": {"username": ""}},
            {
                "step_number": 8, "name": "Audit Confirmation", "type": "human_checkpoint",
                "prompt": "Confirm all access has been revoked and audit log is complete",
