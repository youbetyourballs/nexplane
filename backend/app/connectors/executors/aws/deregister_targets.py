...
async def execute(parameters: dict, asset_ids: list, connector) -> dict:
    ...
    if not creds:
        return {"action": "deregister_targets", "tg_arn": tg_arn, "targets": targets, "mock": True}
    ...
    return {"action": "deregister_targets", "tg_arn": tg_arn, "targets": targets, "executed_at": datetime.now(timezone.utc).isoformat()}
