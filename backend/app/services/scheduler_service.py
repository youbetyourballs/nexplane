...
def _register_operational_jobs():
    ...
    logger.info("Registered operational scheduler jobs: reboot-dispatcher, access-review-check, compliance-scan-weekly, maintenance-window-checker, runbook-executor")
