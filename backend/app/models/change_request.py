...
class ChangeType(str, enum.Enum):
    ...
    macos_santa_install = "macos_santa_install"
    macos_santa_check = "macos_santa_check"
    macos_santa_rule_add = "macos_santa_rule_add"
    macos_santa_rule_list = "macos_santa_rule_list"
    macos_santa_rule_remove = "macos_santa_rule_remove"
    macos_santa_mode_set = "macos_santa_mode_set"
    macos_santa_event_export = "macos_santa_event_export"
    macos_santa_binary_check = "macos_santa_binary_check"
    macos_santa_sync_trigger = "macos_santa_sync_trigger"
    macos_gatekeeper_status = "macos_gatekeeper_status"
    ...
    # Linux parallel upgrade (provision new host, sync data, cutover, decommission)
